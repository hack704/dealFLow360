...
export const DiscountTiersSetupPage = () => {
  ...
  // Category discount ceilings state
  ...
  const [routingRules, setRoutingRules] = useState([
    ...
    { id: 3, range: 'Over limit, blended risk high', requirement: 'Sales manager then finance', badge: 'danger' },
    { id: 4, range: 'Exceeds 25% or Negative Margin', requirement: 'Executive VP + CFO Sign-off', badge: 'danger' }
  ]);
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      <div className="bg-white/80 dark:bg-[#161618]/90 border border-black/[0.08] dark:border-white/[0.08] rounded-[22px] overflow-hidden backdrop-blur-xl shadow-sm dark:shadow-apple-card">
        <div className="px-6 py-4 border-b border-black/[0.08] dark:border-white/[0.08] flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-[15px] font-semibold text-[#1d1d1f] dark:text-[#f5f5f7]">
              Approval Escalation & Routing Matrix
            </h3>
          </div>
          <span className="text-[13px] text-[#86868b] font-mono whitespace-nowrap">Dynamic CPQ Rules</span>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-[13px] text-[#1d1d1f] dark:text-[#f5f5f7]">
            <thead className="bg-neutral-50 dark:bg-white/[0.02] text-[#86868b] uppercase tracking-wider font-mono text-[13px] font-semibold border-b border-black/[0.08] dark:border-white/[0.08]">
              <tr>
                <th className="py-3.5 px-5 whitespace-nowrap">Discount Range / Breach Condition</th>
                <th className="py-3.5 px-5 text-right whitespace-nowrap">Approval Level Required</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-black/[0.06] dark:divide-white/[0.06]">
      ...
      <div className="p-5 rounded-2xl border border-[#ff9f0a]/30 bg-[#ff9f0a]/[0.08] dark:bg-[#ff9f0a]/[0.06] text-[13px] text-[#1d1d1f] dark:text-[#f5f5f7] flex items-start space-x-3.5">
        <div className="w-9 h-9 rounded-xl bg-[#ff9f0a]/15 flex items-center justify-center shrink-0 text-[#ff9f0a] mt-0.5">
          <AlertTriangle className="w-4.5 h-4.5" />
        </div>
        <div className="space-y-1">
          <span className="font-semibold text-[#9e5200] dark:text-[#ff9f0a]">Blended Risk Calculation & Audit Mandate: </span>
